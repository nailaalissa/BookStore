...
namespace BookStoreSite.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        public BooksController(BookStoreSiteContext context)
        {
            _context = context;
        }
       ...
       /* public async Task<IActionResult> Search(string searchString, string minPrice, string maxPrice, string category)
        {
...
*/
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("Id,Title,Category,Description,Language,ISBN,DatePublished,Price,Author,ImageUrl")] Book book)
        {
            // Existing code...
